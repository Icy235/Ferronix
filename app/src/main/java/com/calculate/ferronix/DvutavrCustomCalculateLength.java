...
public class DvutavrCustomCalculateLength extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dvutavr_custom_calculate_lenght);
    ...
    private void calculateLength() {
        try {
            ...
            // Рассчитываем площадь поперечного сечения двутавра
            double areaFlanges = 2 * (widthBCm * thicknessTCm); // площадь двух полок
            double areaWeb = (heightHCm - 2 * thicknessTCm) * thicknessSCm; // площадь стенки
            double totalArea = areaFlanges + areaWeb; // общая площадь сечения
    ...
    public void btnGoMass(View view) {
        startActivity(new Intent(this, DvutavrCustomCalculateWeight.class));
