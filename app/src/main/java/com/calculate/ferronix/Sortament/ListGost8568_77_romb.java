...
public class ListGost8568_77_romb extends AppCompatActivity {
    ...
    private String[] mark;
    // Инициализация массивов для ГОСТ 8568-77 С ромбическим рифлением
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.list_gost_8568_77_romb_calculate);
    ...
    private void calculateWeight() {
        try {
            ...
            analytics.put("Шаблон", "Лист ромбический ГОСТ 8568-77");
