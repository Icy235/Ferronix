...
public class Gost8239_89_pdf extends AppCompatActivity {

    private static final String PDF_NAME = "gost_8239_89.pdf";
    private PDFView pdfView;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.gost_8239_89_pdf);
    ...
    private void loadPdfFromAssets() {
        pdfView.fromAsset(PDF_NAME)
                ...
                .onError(error -> {
                    ...
                    Toast.makeText(Gost8239_89_pdf.this, "Ошибка загрузки PDF", Toast.LENGTH_SHORT).show();
                })
                .load();
    }
