...
public class Gost8568_77_pdf extends AppCompatActivity {

    private static final String PDF_NAME = "gost_8568_77.pdf";
    private PDFView pdfView;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.gost_8568_77_pdf);
    ...
    private void loadPdfFromAssets() {
        pdfView.fromAsset(PDF_NAME)
                ...
                .onError(error -> {
                    ...
                    Toast.makeText(Gost8568_77_pdf.this, "Ошибка загрузки PDF", Toast.LENGTH_SHORT).show();
                })
                .load();
    }
