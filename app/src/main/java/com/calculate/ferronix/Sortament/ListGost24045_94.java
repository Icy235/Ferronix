...
public class ListGost24045_94 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.list_gost_24045_94_calculate);
    ...
    private void calculateLength() {
        try {
            ...
            analytics.put("Шаблон", "Лист ГОСТ 24045-94");
    ...
    private void calculateWeight() {
        try {
            ...
            analytics.put("Шаблон", "Лист ГОСТ 24045-94");
            analytics.put("Марка", btnMark.getText().toString());
            analytics.put("Масса", massStr);

            if (!quantityStr.isEmpty()) analytics.put("Количество", quantityStr);
            if (!pricePerKgStr.isEmpty()) analytics.put("Цена за кг", pricePerKgStr);
            // Отправляем данные
            NetworkHelper.sendCalculationData(this, analytics);
            // Выводим результат
            totalWeight.setText(resultText.toString());
    ...
    public void btnGost24045_93_pdf(View view) {
        startActivity(new Intent(this, Gost24045_94_pdf.class));
        finish();
    }
}