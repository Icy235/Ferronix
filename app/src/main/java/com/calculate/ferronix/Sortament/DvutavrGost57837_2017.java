...
public class DvutavrGost57837_2017 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dvutavr_gost_57837_2017_calculate);
    ...
    private void calculateLength() {
        try {
            ...
            analytics.put("Шаблон", "Двутавр ГОСТ 57837-2017");
    ...
    public void btnGost57836_2017_pdf(View view) {
        startActivity(new Intent(this, Gost57837_2017_pdf.class));
        finish();
    }
}