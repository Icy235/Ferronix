...
public class CornerCalculateWeight extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_corner_weight_calculate);
    ...
    public void btnGoLength(View view) {
        startActivity(new Intent(this, CornerCalculateLength.class));
        finish();
    }
}